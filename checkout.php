...
$querry = "select sum(p_price) as total_price from cart_items";
$result = mysqli_query($con,$querry);
$fetch = mysqli_fetch_object($result);

$OID ="fd536fg3113h7565ssh";
      ...
      <form  action="payscript.php" method="post" style="padding: 25px;">
        ...
        <div class="row" >
          <div class="col-25">
            ...
            <input type="text" value="<?php echo $OID.rand(100,1000);?>" name="orderid">
            <input type="hidden" value="<?php echo $fetch->total_price;?>" name="amount">
